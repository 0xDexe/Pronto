...
public class Camera2BasicFragment extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    case Constants.MESSAGE_STATE_CHANGE:
                        ...
                        switch (message.arg1) {
                            ...
                            case Constants.STATE_NONE:
                                showToast("Not connected to master");
                                break;
                        }
                        break;
        ...
        comm = new BluetoothComm(this, UIHandler);
        comm.start();
    }

    private void bluetoothSearch() {
        BluetoothDevicesListView display = new BluetoothDevicesListView(mBluetoothAdapter, comm);
        display.show(this);
    }
    ...
    {
        String send = JSONUtil.makeJSON("Image", "Image", image);
        comm.write(send.getBytes());
    }
